...
setInput::setInput()
{
  ...
  AddOption("density", "Density of the Rod", density);
	...
	AddOption("C-translation", "numerical prefactor to multiply force against head translation", C_translation);
	AddOption("C-rotation", "numerical prefactor to multiply force against head rotation", C_rotation);
